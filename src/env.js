...
export const env = createEnv({
  ...
  runtimeEnv: {
    ...
    NEXT_PUBLIC_BESE_URL: process.env.NEXT_PUBLIC_BESE_URL,
    ...
    NEXT_PUBLIC_ENTERPRISE_PRICE_ID:
      process.env.NEXT_PUBLIC_ENTERPRISE_PRICE_ID,
